  ...
  return (
    <div className="space-y-4 font-sans text-right animate-fadeIn" dir="rtl">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-3.5 shadow-sm space-y-3">
        ...
        <div className="flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400 font-medium pt-1 border-t border-slate-100 dark:border-slate-800">
          ...
          <button
            ...
            className="text-emerald-700 dark:text-emerald-300 hover:text-emerald-800 dark:hover:text-emerald-200 font-bold flex items-center gap-1.5 bg-emerald-50 dark:bg-emerald-950/60 hover:bg-emerald-100 dark:hover:bg-emerald-900/60 px-2.5 py-1 rounded-lg border border-emerald-200/80 dark:border-emerald-800/80 transition cursor-pointer active:scale-95 shadow-sm"
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border-2 border-slate-200 dark:border-slate-800 shadow-md overflow-hidden">
        ...
        <div className="bg-slate-100 dark:bg-slate-800/90 border-b border-slate-200 dark:border-slate-700/80 px-4 py-2 flex items-center justify-between text-xs font-mono text-slate-600 dark:text-slate-300">
          <div className="flex items-center gap-2">
            <span className="px-2 py-0.5 rounded bg-emerald-600 text-white font-extrabold text-[10px]">
              FX = ATTENDANCE_LOG()
            </span>
            <span className="text-[11px] font-sans font-bold text-slate-700 dark:text-slate-200">
              جدول سجلات الحضور اليومية للطالب: <strong className="text-emerald-600 dark:text-emerald-400">{studentName}</strong>
            </span>
          </div>
          <div className="text-[11px] font-sans font-semibold text-slate-500 dark:text-slate-400">
            شيت تفاعلي (Grid View)
          </div>
        </div>

        {/* SCROLLABLE TABLE CONTENT - TOUCH SMOOTH HORIZONTAL SCROLL ON MOBILE */}
        <div className="overflow-x-auto w-full max-h-[500px] touch-pan-x scrollbar-thin scrollbar-thumb-slate-300 dark:scrollbar-thumb-slate-700">
